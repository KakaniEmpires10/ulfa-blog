<form class="is-flex is-flex-direction-column" style="gap: 1rem;" action="<?= site_url('admin/settings/update') ?>" method="POST" x-data="{ isLoading: false }" @submit="isLoading = true">
    <?= csrf_field() ?>
